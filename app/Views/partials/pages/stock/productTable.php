<?php if (count($produtos) > 0): ?>
    ...
    <tr>
        ...
        <td data-label="Valor:">
            R$ <?php echo number_format((float)$product['product_price'], 2, '.', ''); ?>
        </td>
        <td data-label="Quantidade:"><?php echo htmlspecialchars($product['product_quantity']); ?></td>
        <td data-label="Status:">
            <?php if ($product['product_quantity'] <= 5): ?>
        ...
        <td data-label="Ações:">
            <button
                ...
                data-quantity="<?php echo htmlspecialchars($product['product_quantity']); ?>"
            >
                <i class="bi bi-eye"></i>
            </button>
            <button
