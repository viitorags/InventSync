<?php if (count($orders) > 0): ?>
    ...
    <tr>
        ...
        <td data-label="Produto:"><?php echo isset($order['product_name'][0]) ? htmlspecialchars($order['product_name'][0]) : "—"; ?></td>
        <td data-label="Data:">
        ...
        <td data-label="Valor:">
            R$ <?php echo number_format((float)$order['order_price'], 2, '.', ''); ?>
        </td>
        <td data-label="Status:">
            ...
            <?php else: ?>
            <span class="status-indicator"><?php echo htmlspecialchars($order['order_status']); ?></span>
            <?php endif; ?>
        </td>
        <td data-label="Ações:">
            <button
            ...
            <button class="remove_product" data-id="<?php echo htmlspecialchars($order['order_id']); ?>">
