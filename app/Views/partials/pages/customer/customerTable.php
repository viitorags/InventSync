...
$clientes = $viewsController->getClient();
?>
<?php if (count($clientes) > 0): ?>
    <?php foreach ($clientes as $cliente): ?>
        <tr>
            ...
            <td data-label="Ações:">
                <button class="visualizar" data-id="<?php echo htmlspecialchars($cliente['client_id']); ?>"
                    data-name="<?php echo htmlspecialchars($cliente['client_name']); ?>"
                    data-number="<?php echo htmlspecialchars($cliente['client_number']); ?>">
                    <i class="bi bi-eye"></i>
                </button>
                <button class="editar" data-id="<?php echo htmlspecialchars($cliente['client_id']); ?>"
                    data-name="<?php echo htmlspecialchars($cliente['client_name']); ?>"
                    data-number="<?php echo htmlspecialchars($cliente['client_number']); ?>">
